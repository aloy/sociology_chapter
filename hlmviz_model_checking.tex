...
\todo[inline]{We can include it in the study, but I would only mention it in the paper and maybe put the lineup in an appendix}
...
The three versions are displayed in figure~\ref{qqplots} and include (from left to right): a standard Q-Q plot, a Q-Q plot with an added 95\% pointwise confidence region based on the estimated standard error of the order statistics for an independent sample from the theoretical distribution,} 
...
Using the Amazon MTurk services, 417 participants were each asked to evaluate ten different lineups. 
