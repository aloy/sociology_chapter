...
\item {\em Artifacts due to the data structure:} Residual plots might display noticeable patterns that are artifacts of the model estimation procedure rather than indications of lack of fit. 
