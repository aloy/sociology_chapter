...
%	\includegraphics[width=\textwidth]{qqplot_normranef_slope_lineup11.pdf}
	...
	\caption{\label{fig:qqlineup-norm} Lineup of 20 normal Q-Q plots for the predicted random slope \hh{intercept? }.  Which is the real plot? \hh{I've replaced this lineup by the one from the previous study. This is the radon data.}}
\end{figure}
