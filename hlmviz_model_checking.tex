...
\hh{Figures~\ref{homogeneous-1} and~\ref{homogeneous-2} show a second example of lineups testing for homogeneous variance. XXX rearrange the plot order and describe XXX here, the focus of the identification is on the outliers. the dot plot doesn't show anything, the box plot is hugely significant. The two designs therefore represent two different tests with different power.}
