...
\hhnote{the distribution needs to be fixed, but it should not change the actual results.}
Under the null hypothesis, $X$ is distributed according to a Binomial distribution with a probability of success of $p = 1/m$\al{---that is,}  $X~\sim~B_{N, p}$. The $p$-value \hh{for this lineup} is then estimated as
...
\hh{Based on 73 evaluations of Figure~\ref{fig:fanned}, 11 observers chose the  data plot from the lineup. This leads us to reject the null hypothesis that the data plot is consistent with the null model with a $p$-value of approximately 0.001. The actual model of the data and the null} \al{hypothesis} \hh{are explained in detail in Section~\ref{sec:select}. The data in this first lineup is shown in panel  $\sqrt{144} + 4$.}
...
\hh{These issues are well-known, and in special circumstances} \al{fixes have been proposed. For example, \cite{Stram:1994wd} suggest using a 50:50 mixture of $\chi^2_q$ and $\chi^2_{q+1}$ when testing $q$ versus $q + 1$ random effects; however, this adjustment is not successful in all cases. Additionally, \cite{Lange:1989uu} suggest using weighted Q-Q plots to assess the distributional assumptions made on the random effects. This approach is effective in settings where the residual variance, $\sigma^2$, is small relative to the variance components for the random effects, but breaks down when this is not the case.} 
...
\hhnote{yes, I agree - we actually need another lineup on this for the new experiment ***LINEUP*** I would suggest to include the random slope in the model from which you simulate the null and draw the same picture again. Hopefully the data disappears.}
...
\begin{figure}
	\centering
	\includegraphics[width=.9\textwidth]{dialyzer-boxplots-lineup8.pdf}
	\caption{ 
...
\begin{table}[ht]
\centering
\caption{\label{tab:results} Overview of all lineup evaluations. Ratios comparing the number correct to the total number of evaluations are shown. Significance was determined from the visual $p$-value defined in Equation~\ref{eqn.pvalue}. \hhnote{pvalues are re-checked}} 
...
% & 1 & 2 & 3 & 4 & 5 \\ 
%  \hline
%autismfanned2 & 6.9e-45 & 1.2e-18 & 9.3e-23 & 9.1e-23 & 1.1e-26 \\ 
%  autismordered & 1.9e-74 & 1.6e-64 & 1.8e-73 & 8.4e-61 & 7.8e-75 \\ 
%  autismunordered & 2.9e-65 & 8.6e-69 & 1.1e-84 & 1e-70 & 9.1e-74 \\ 
%  cyclone & 1.3e-46 & 4.1e-42 & 7.2e-42 & 4.1e-40 & 1.3e-50 \\ 
%  dialyzerheterogeneous & 5.2e-17 & 0.0014 & 2.1e-15 & 0.03 & 5.4e-05 \\ 
%  dialyzernonlinear & 3e-74 & 4e-78 & 2e-70 & 9.8e-104 & 6.1e-82 \\ 
%%  electoral & 1.9e-11 & 0.00041 & 0.31 & 1.2e-05 & 0.00023 \\ 
%  examcorr & 1.9e-35 & 4.4e-69 & 1.6e-23 & 2.7e-58 & 9.1e-60 \\ 
%  examfanned & 0.00098 & 0.06 & 0.0049 & 2e-05 & 0.068 \\ 
%  examuncorr & 0.038 & 4.9e-06 & 2e-12 & 3.1e-15 & 0.66 \\ 
%  radontranef & 9.9e-20 & 5.8e-48 &   1 & 5.6e-06 & 0.17 \\ 
%   \hline
% autismfanned2 & 6.7e-45 & 1.1e-18 & 8.8e-23 & 8.5e-23 & 1e-26 \\ %  autismordered & 1.9e-74 & 1.6e-64 & 1.7e-73 & 8.3e-61 & 7.7e-75 \\ %  autismunordered & 2.9e-65 & 8.5e-69 & 1.1e-84 & 1e-70 & 9.1e-74 \\ %  cyclone & 1.3e-46 & 4e-42 & 7e-42 & 3.9e-40 & 1.3e-50 \\ %  dialyzerheterogeneous & 4.7e-17 & 0.0095 & 1.9e-15 & 0.041 & 0.0018 \\ %  dialyzernonlinear & 3e-74 & 3.9e-78 & 2e-70 & 9.8e-104 & 6.1e-82 \\ %  electoral & 1.7e-11 & 0.0055 & 0.15 & 0.00097 & 0.004 \\ %  examcorr & 1.8e-35 & 4.4e-69 & 1.5e-23 & 2.6e-58 & 9e-60 \\ %  examfanned & 0.0081 & 0.059 & 0.018 & 0.001 & 0.06 \\ %  examuncorr & 0.046 & 0.00033 & 1.7e-12 & 2.8e-15 & 0.22 \\ %  radontranef & 9.2e-20 & 5.7e-48 & 0.15 & 0.00053 & 0.088 \\ %   \hline
%\end{tabular}
