...
is consistent with the model that generated the data on which all of the other plots are based on. The  model in question, the corresponding null hypothesis and the calculation of $p$-values are explained in detail in Sections~\ref{sec:select} and Appendix~\ref{sec:pvalues}. 
...
In Section~\ref{sec:select} we focus on model building. In Section~\ref{sec:checking} we present graphical tests for model validation. \al{Throughout both sections we provide multiple examples of the use of visual inference and draw comparisons with conventional tools.} \hh{All example datasets are readily available for public use. A short description of each of them can be found in appendix~\ref{sec:datasets}}
...
Only one out of  59 participants identified the data plot shown in panel \#$(4^2 - 6)$ from the lineup, providing no evidence against homogeneity \alnote{XXX Do we want to use the combined p-value? XXX}. \al{In this situation the ``conventional'' test agrees with the visual test with a $p$-value of 0.149, if counties with fewer than 10 observations are excluded. If only counties with fewer than 5 observations are excluded, the conventional test indicates strong evidence of heterogeneity based on a $p$-value of 0.0185. This sensitivity to the group size is a clear weakness of the conventional test, and casts doubt on its usefulness in situations with small group sizes. In contrast, the visual test is not overly sensitive to group sizes. Counties with less than 5 observations were eliminated because boxplots are not appropriate for such small group sizes. While we are still slightly constrained with group sizes, we are far less constrained than in the conventional test.}
...
\hh{Once a polynomial of degree four is included in the mean structure of the fixed effects, a smooth line through the residuals is flattened out -- a lineup of this situation is shown in figure~\ref{fig:constvar2}. In this lineup, the data is picked out for heteroscedasticity in the residuals by pressure.  This highlights the use of lineups as omnibus tests. Using the same setup we will get test results based on where we are in the modeling process: as long as the mean structure is not correctly specified, it is most likely the most distinguishing feature. Once the mean structure is taken care of, the lineup changes to test for homogeneity of variance. }
...
% Weighting was used to accommodate  multiple reasons. \hhnote{something went wrong - the numbers don't match up with the lineups.}}
%\begin{tabular}{Mllrrrrrr}
%  \hline
%  &&& \multicolumn{5}{c}{Choice} & \multicolumn{1}{c}{Total}\\ \cline{4-8}
%\multicolumn{2}{c}{Lineup} & pick & Outlier & Spread & Trend & Asymmetry & Other &  evaluations\\ 
%  \hline
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{examfanned-icon} } &
% \multirow{2}{*}{ fig.~\ref{fig:fanned}} & data & 17.3 & 20.2 & 28.1 & 23.7 & 10.7 & 164 \\ 
%& & null & 27.4 & 39.9 & 21.5 & 6.6 & 4.6 & 162 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{examfanned-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:fanned2}} & data & 36.1 & 33.3 & 14.9 & 4.9 & 10.8 & 46 \\ 
%  & & null & 38.8 & 17.7 & 20.4 & 13.4 & 9.6 & 276 \\  [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{autism-ordered-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:boxplot-ordered}} & data & 10.2 & 8.9 & 38.9 & 31.3 & 10.7 & 287 \\ 
% & & null & 28.7 & 3.2 & 24.5 & 23.9 & 19.8 & 37 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{autism-unordered-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:boxplot-unordered}} & data & 13.5 & 9.1 & 31.7 & 33.9 & 11.7 & 286 \\ 
% & & null & 30.0 & 0.4 & 23.4 & 29.4 & 16.9 & 32 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{examcorr-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:ranef-corr}} & data & 12.4 & 6.6 & 61.5 & 14.3 & 5.2 & 230 \\ 
%  & & null & 16.9 & 31.4 & 30.2 & 14.6 & 7.0 & 93 \\  [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{dialyzerheterogeneous-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:constvar2}}  & data & 23.9 & 30.5 & 23.4 & 17.1 & 5.1 & 79 \\ 
%  & & null & 32.9 & 26.4 & 18.1 & 15.7 & 6.9 & 247 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{dialyzerheterogeneous-bp}} &
%   \multirow{2}{*}{  fig.~\ref{fig:constvar2.bp}}   & data & 26.9 & 19.3 & 27.6 & 26.1 &  & 100 \\ 
%  & & null & 30.2 & 24.2 & 26.3 & 13.8 & 5.5 & 245 \\  [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{homogeneous-dots-icon}} &
%   \multirow{2}{*}{  fig.~\ref{homogeneous-1}}  & data & 25.4 & 28.2 & 29.6 & 16.9 &  & 12 \\ 
%  & & null & 38.9 & 33.9 & 13.4 & 12.5 & 1.4 & 318 \\  [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{homogeneous-bp-icon}} &
%   \multirow{2}{*}{  fig.~\ref{homogeneous-2}}  & data & 45.3 & 37.3 & 8.4 & 7.3 & 1.7 & 148 \\ 
%  & & null & 29.1 & 25.7 & 28.3 & 12.1 & 4.8 & 176 \\  [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{cyclone-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:badcyclone}} & data & 17.5 & 10.4 & 33.6 & 21.8 & 16.7 & 223 \\ 
% & & null & 39.7 & 23.0 & 21.4 & 12.6 & 3.3 & 100 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{cyclone-good-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:goodcyclone}}  & data & 35.4 & 4.2 & 12.6 & 47.8 &  & 12 \\ 
% & & null & 29.4 & 24.1 & 18.7 & 24.0 & 3.8 & 329 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{dialyzernonlinear-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:linearity}}  & data & 12.4 & 7.3 & 52.2 & 20.7 & 7.4 & 305 \\ 
%  & & null & 50.3 & 22.4 & 18.9 & 8.4 &  & 14 \\ [5pt]
%%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{dialyzernonlinear-icon}} &
%%   \multirow{2}{*}{  fig.~\ref{fig:linearity}} & data & 32.9 & 43.8 & 17.2 & 3.7 & 2.4 & 63 \\ 
%%  turk11-examuncorr & null & 29.9 & 34.2 & 16.0 & 12.6 & 7.2 & 250 \\ 
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{radontranef-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:qqlineup-t}} & data & 53.4 & 20.0 & 22.7 & 1.1 & 2.7 & 92 \\ 
%  & & null & 35.4 & 8.3 & 37.4 & 10.0 & 8.9 & 230 \\  [5pt]
%%\multicolumn{2}{c}{\multirow{2}{*}{random intercept}}
%random  &
%  & data & 60.0 &  & 40.0 &  &  & 3 \\ 
%intercept & & null & 39.0 & 14.6 & 34.4 & 10.7 & 1.3 & 348 \\ 
%%\multicolumn{2}{c}{random slope} 
%random slope &
%& null & 33.1 & 17.3 & 36.6 & 9.7 & 3.3 & 307 \\ [5pt]
%\multirow{2}{*}{\includegraphics[width=0.05\textwidth]{autism2-fanned-icon}} &
%   \multirow{2}{*}{  fig.~\ref{fig:autism-ranef}}   & data & 12.8 & 58.7 & 14.0 & 14.5 &  & 20 \\ 
