...
(\citet{mahbub:2013} introduce visual $p$-values, for detailed calculations see Appendix~\ref{sec:pvalues}).
...
Observers were asked the question `Which plot is the most different?'. 
   Any  information revealing the context of the data, such as axis labels, units, titles, and legends,  was carefully removed to  avoid subjective bias \citep{meilgaard} and prevent observers from making decisions that were not purely based on the data display. 
