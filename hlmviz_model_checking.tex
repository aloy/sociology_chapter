...
\if0\blind
{
  \title{\bf  Graphical Diagnostics for Linear Mixed-Effects Models Using Visual Inference}
...
model fits based on graphical tests that can be broadly used in situations where 
