...
Finally, the lineups in Figures~\ref{fig:qqlineup-norm} and \ref{fig:qqlineup-t} are used to test the assumption of normality. 


In Section~\ref{sec:conv-check} we discussed...
