...
\todo[inline]{It reads fine as is, but the shoulds and coulds need to go in the next paragraph :)}
\alnote{I think those are taken care of now}
...
\alnote{What significance level was used? I assume 5\%, but I don't want to guess wrong.}
Out of the 48 non-normal samples, 24 get rejected based on evaluation by observers. None of the classical tests come close to that rejection rate. From left to right, we see the number of rejections from visual inference as well as the Anderson-Darling, Shapiro-Wilk, Cram\'er-von Mises and Kolmogorov-Smirnov tests for normality.}
\end{table}
