...
\begin{tabular}{rrlrlrlrlrl}
 ...
 replicate & 1 & & 2 && 3 && 4 && 5 \\ 
  ...
  radon  & 0/29&  &  \\ 
  radontranef & 29/70&\hspace{-0.1in}***  & 52/79&\hspace{-0.1in}*** & 0/64& & 13/59&\hspace{-0.1in}*** & 6/74&\hspace{-0.1in}. \\ 
...
\alnote{Were there 29 or 23 Turkers in Lendie's study? I have 23 in the body of the paper, but certainly could have transcribed that incorrectly.}
\end{table}
...
\alnote{I might be a little spacey, but these look like $P(X > x)$ rather than $P(X \ge x)$}
\end{table}
