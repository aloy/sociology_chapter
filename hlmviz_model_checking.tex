...
At the core of this criticism is the fact that decisions are  based on a single plot. With only a single plot,  the detection of any unexpected structure leads to the conclusion that the model is inappropriate; however, in complex models we often observe structures 
...
Unlike classical hypothesis tests, visual inference  allows us to additionally collect information on what aspect of the display led each observer to their choice. 
