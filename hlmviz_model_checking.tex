...
\alnote{We use a parametric bootstrap here, so we can't claim that the simulation is non-parametric.}
We have presented a graphical approach to model selection and diagnosis based on non-parametric simulation from the model. % fit to the true data. 
...
\hhnote{variability in results due to  sample of null sets}
