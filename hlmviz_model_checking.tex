...
Note that none of the data plots in the lineups were actually created using data from a normal distribution. This should lead to rejection of the null hypothesis in every single instance. This is not quite true. But  the visual inference test manages to reject much more often than any of the classical tests:
