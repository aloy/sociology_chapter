...
Data for the null plots were generated from a parametric bootstrap \al{as outlined in Section~\ref{app:nullplots} of the appendix.
...
\hh{If a covariate is discrete, we also have the choice to use side-by-side boxplots to visualize residuals.  For the example of  the dialyzer study, we employed side-by-side boxplots and side-by-side dotplots to visualize  level-1 residuals against the discrete design variable of pressure. } 
...
\hh{When assessing the homogeneity of level-1 residual across groups, we are, by default, in the situation of comparing continuous values across a discrete range. A further complication is introduced in this assessment when the group sizes are very unbalanced, because this introduces structures that are largely artificial. }
