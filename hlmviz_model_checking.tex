...
Using the Amazon Turk services, 417 participants were each asked to evaluate five lineups of different types. This resulted in $n = $4018 responses.
\[
...
$\ell_{\ell(i)}$ & lineup difficulty, $\ell_{\ell(i)} \sim N(0,1)$ i.i.d 
\end{tabular}
\end{center}
