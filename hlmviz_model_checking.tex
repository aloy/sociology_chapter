...
To determine whether lineups can detect distributional violations we constructed another lineup where the ``true plot'' was constructed from random effects simulated from a $t_3$ distrubution. This lineup is show in Figure~\ref{fig:qqlineup-t}. \al{XXX out of XXX} identified the true plot (panel $\sqrt{49} - 1$), providing evidence against the null hypothesis of normality.  
...
%	\includegraphics[width=\textwidth]{qqplot_normranef_slope_lineup11.pdf}
	...
	\alnote{Is panel 7 the real data? I think this was changed at some point.}
