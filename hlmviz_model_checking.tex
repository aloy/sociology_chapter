...
\citep[][introduced visual $p$-values. Details of the calculation for this LME model application are in Section~2.1 of the supplement.]{mahbub:2013}
...
In this setting, the null plots are generated using the parametric bootstrap  with a model that omits the variable of interest, \al{details of which can be found in Section~2.2 of the supplement}. The true plot is constructed from the same model, but is fit to the observed data. 
...
Data for the null plots were generated from a parametric bootstrap \al{as outlined in Section~\ref{app:nullplots} of the supplement.
...
\al{Figures~13 and~14 in Section~2.2 of the supplement show the resulting lineups.}
