...
\hh{In Figure~\ref{fig:qqlineup-1} we inserted into the lineup the Q-Q plot of the predicted random slopes of model (1) fit to the radon data, while the lineup in Figure~\ref{fig:qqlineup-t} included a Q-Q plot of the random slopes in model (1) where error terms for the re-fit were simulated from a  $t_3$-distribution.}
