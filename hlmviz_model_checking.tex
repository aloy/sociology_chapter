...
\al{
In sections~\ref{sec:select} and \ref{sec:checking} we discuss how visual inference can be utilized to select and validate hierarchical linear models. While we focus on example in which we encounter problems with conventional inference, visual inference can be applied more generally...
}
