...
\hh{***LINEUP*** for homogeneity - what about the dialyzer example with side by side boxplots for flow speed}
...
Reference to Hodges (1998): Hodges, J. (1998). Some algebra and geometry for hierarchical models, applied to diagnostics. \emph{Journal of the Royal Statistical Society. Series B (Statistical Methodology)}, 60(3), 497Ð536.\\[1em]
...
\begin{figure}
	...
	\caption{\label{fig:qqlineup-t} Lineup  testing for normality of the random slope for the radon data. Which of the plots is the most different? Which feature led you to your choice? \hh{this is the simulation from $t$, right? if so, it needs to say that. the file name suggests it.}}
\end{figure}
