...
\alnote{Do we need citations for ML and REML? It is so well known that I didn't include them, but would convention dictate that we do?}

\hhnote{I don't think that we'd need them ... }
