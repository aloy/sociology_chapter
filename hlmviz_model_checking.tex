...
\alnote{Should we spell out the ``linear mixed-effects model'' each time, or use the abbreviation? I think LME is well-known in the community, so it shouldn't add undue burden on the reader, but that is just my opinion.}
