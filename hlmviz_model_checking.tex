...
\item {\bf Render lineups:}  Draw small multiples of each of the null data sets and randomly insert the observed data among the nulls. Each plot is labelled by a number from 1 to $m$. These IDs are used for identification  and later evaluation of results.
