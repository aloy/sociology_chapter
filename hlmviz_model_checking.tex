...
\hh{Technical implementation: R \cite{R} and packages for modeling lme4 \cite{lme4}, HLMDiag \cite{HLMDiag}, and visualizations ggplot2 \cite{ggplot2}, nullabor \cite{nullabor}, gridSVG \cite{gridSVG}. 
