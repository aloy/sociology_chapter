...
\includegraphics[width=0.05\textwidth]{radontranef-icon}&   fig.~10 & 26/63 & \hspace{-0.1in}*** & 48/75 & \hspace{-0.1in}*** & 0/59 & \hspace{-0.1in}  & 11/56 & \hspace{-0.1in}** & 6/69 & \hspace{-0.1in}  & $< 10^{-4}$ \\ 
