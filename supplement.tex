...
``Better Diagnostics for Linear Mixed-Effects Models Using Visual Inference.'' Section~\ref{supp:model} gives an overview of the theoretical framework of linear mixed effects models. Section~\ref{supp:datasets} describes the data sets used to illustrate the use of visual inference in the paper.
